                    ...
                    <div>
                        ...
                        <div class="card mb-3 text-start">
                            <div class="card-body">
                                ...
                                <p>
                                    Les informations recueillies sur ce formulaire sont enregistrées dans un fichier informatisé par <strong>Yassif Radwa</strong> pour <strong>l'authentification des utilisateurs</strong>. La base légale du traitement est <strong>le consentement</strong>.
                                    <br/><br/>
